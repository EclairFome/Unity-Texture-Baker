...
With no built-in bake option available in my version of Poiyomi, I needed a way to export the final shader output as a plain texture that could be used without any shader magic, this tool was the result.
